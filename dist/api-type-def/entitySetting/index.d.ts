 ...
 * @returns {void}
 */
type SetTargetedPlayerSettingForEveryone = <Setting extends keyof EntitySettings>(targetedPlayerId: PlayerId, settingName: Setting, settingValue: EntitySettings[Setting], includeNewJoiners?: boolean) => void;
/**
 ...
 * @returns {void}
 */
type SetEveryoneSettingForPlayer = <Setting extends keyof EntitySettings>(playerId: PlayerId, settingName: Setting, settingValue: EntitySettings[Setting], includeNewJoiners?: boolean) => void;
/**
 ...
 * @returns {void}
 */
type SetOtherEntitySetting = <Setting extends keyof EntitySettings>(relevantPlayerId: PlayerId, targetedEntityId: EntityId, settingName: Setting, settingValue: EntitySettings[Setting]) => void;
/**
 ...
 * @returns {void}
 */
type SetOtherEntitySettings = (relevantPlayerId: PlayerId, targetedEntityId: EntityId, settingsObject: Partial<EntitySettings>) => void;
/**
 ...
 */
type GetOtherEntitySetting = <Setting extends keyof EntitySettings>(relevantPlayerId: PlayerId, targetedEntityId: EntityId, settingName: Setting) => EntitySettings[Setting];
