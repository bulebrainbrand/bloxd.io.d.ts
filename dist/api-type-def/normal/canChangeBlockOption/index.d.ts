export declare const SetCanChangeApis: {
    ...
    setCanChangeBlockType: (playerId: import("../../..").PlayerId, blockName: import("../../..").BlockNameOrId) => void;
    ...
    setCantChangeBlockType: (playerId: import("../../..").PlayerId, blockName: import("../../..").BlockNameOrId) => void;
