 ...
 */
declare const attemptCreateMeshEntity: <TMeshType extends MeshType>(type: TMeshType, opts: MeshEntityOpts[TMeshType], name?: string, physicsOptions?: MeshEntityPhysicsOpts, initiatorId?: EntityId | null) => EntityId | null;
