 ...
 * @returns {void}
 */
declare const changePlayerIntoSkin: <TCosmeticType extends CosmeticType>(playerId: PlayerId, cosmeticType: TCosmeticType, cosmeticName: CosmeticName<TCosmeticType>) => void;
