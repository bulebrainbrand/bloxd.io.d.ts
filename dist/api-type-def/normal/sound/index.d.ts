export declare const SoundApis: {
    broadcastSound: (soundName: import("../../..").SoundName | string, volume: number, rate: number, posSettings?: import("../../..").PosSettings, exceptPlayerId?: import("../../..").PlayerId) => void;
