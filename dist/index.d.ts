...
export declare type AttackEffectDuration<K extends MobType> = AttackEffectDurationDictionary[K];

declare type AttackEffectDurationDictionary = Record<MobType, number>;

export declare type AttackEffectName<K extends MobType> = AttackEffectNameDictionary[K];

declare type AttackEffectNameDictionary = Record<MobType, string | null>;

export declare type AttackImpulse<K extends MobType> = AttackImpulseDictionary[K];

declare type AttackImpulseDictionary = Record<MobType, number>;

export declare type AttackInterval<K extends MobType> = AttackIntervalDictionary[K];

declare type AttackIntervalDictionary = Record<MobType, number>;

export declare type AttackItemName<K extends MobType> = AttackItemNameDictionary[K];
...
export declare type BaseJumpImpulseXZ<K extends MobType> = BaseJumpImpulseXZDictionary[K];

declare type BaseJumpImpulseXZDictionary = Record<MobType, number>;

export declare type BaseJumpImpulseY<K extends MobType> = BaseJumpImpulseYDictionary[K];

declare type BaseJumpImpulseYDictionary = Record<MobType, number>;

export declare type BaseRunningSpeed<K extends MobType> = BaseRunningSpeedDictionary[K];

declare type BaseRunningSpeedDictionary = Record<MobType, number>;

export declare type BaseWalkingSpeed<K extends MobType> = BaseWalkingSpeedDictionary[K];
...
export declare type BurstAttackInfo<K extends MobType> = BurstAttackInfoDictionary[K];

declare type BurstAttackInfoDictionary = Record<MobType, {
...
export declare type ClientOptions = GenerateClientOptions_2<AllClientOptionUnion>;
...
export declare type EntitySettings = GenerateClientOptions<AllEntitySettingUnion>;
...
declare type GenerateClientOptionInterface<U extends ClientOptionExportFormat, K extends keyof any> = MargeObject<UnionToIntersection<U extends any ? (K extends keyof U ? U[K] : never) : never>>;
...
declare type GenerateEntitySettingInterface<U extends EntitySettingExportFormat, K extends keyof any> = MargeObject<UnionToIntersection_2<U extends any ? (K extends keyof U ? U[K] : never) : never>>;
...
declare interface GetClientOption_11 {
     ...
     * @returns {boolean}
     */
    getClientOption(playerId: PlayerId, option: "showPlayersInUnloadedChunks"): boolean;
}
...
declare interface GetClientOption_29 {
     ...
     * @returns {boolean}
     */
    getClientOption(playerId: PlayerId, option: "showBasicMovementControls"): boolean;
}
...
declare interface GetClientOption_31 {
     ...
     * @returns {string | CustomTextStyling}
     */
    getClientOption(playerId: PlayerId, option: "middleTextLower"): string | CustomTextStyling;
}
...
declare interface GetClientOption_32 {
     ...
     * @returns {string | CustomTextStyling}
     */
    getClientOption(playerId: PlayerId, option: "crosshairText"): string | CustomTextStyling;
}
...
declare interface GetClientOption_37 {
     ...
     */
    getClientOption(playerId: PlayerId, option: "chatChannels"): {
        channelName: string;
        elementContent: string | CustomTextStyling;
        elementBgColor: string;
    }[];
...
declare interface GetClientOption_41 {
     ...
     */
    getClientOption(playerId: PlayerId, option: "compassTarget"): string | number | number[];
}
...
declare interface GetClientOption_54 {
     ...
     * @returns {number}
     */
    getClientOption(playerId: PlayerId, option: "effectDamageReductionDuration"): number;
}
...
declare interface GetClientOption_63 {
     ...
     * @returns {boolean}
     */
    getClientOption(playerId: PlayerId, option: "airMomentumConservation"): boolean;
}
...
declare interface GetClientOption_69 {
     ...
     * @returns {number}
     */
    getClientOption(playerId: PlayerId, option: "dealingDamageLegMultiplier"): number;
}
...
declare interface GetClientOption_77 {
     ...
     * @returns {number}
     */
    getClientOption(playerId: PlayerId, option: "receivingDamageMultiplier"): number;
}
...
declare interface GetOtherEntitySetting_10 {
     ...
     * @returns {ValueType}
     */
    getOtherEntitySetting(relevantPlayerId: PlayerId, targetedEntityId: EntityId, settingName: typeof name_9): ValueType_9;
}
...
declare interface GetOtherEntitySetting_11 {
     ...
     * @returns {NameTagInfo}
     */
    getOtherEntitySetting(relevantPlayerId: PlayerId, targetedEntityId: EntityId, settingName: typeof name_10): ValueType_10;
}
...
declare interface GetOtherEntitySetting_12 {
     ...
     */
    getOtherEntitySetting(relevantPlayerId: PlayerId, targetedEntityId: EntityId, settingName: typeof name_11): ValueType_11;
}
...
declare interface GetOtherEntitySetting_13 {
     ...
     */
    getOtherEntitySetting(relevantPlayerId: PlayerId, targetedEntityId: EntityId, settingName: typeof name_12): ValueType_12;
}
...
declare interface GetOtherEntitySetting_14 {
     ...
     * @returns {StringColor}
     */
    getOtherEntitySetting(relevantPlayerId: PlayerId, targetedEntityId: EntityId, settingName: typeof name_13): ValueType_13;
}
...
declare interface GetOtherEntitySetting_3 {
     ...
     * @returns {0| 1}
     */
    getOtherEntitySetting(relevantPlayerId: PlayerId, targetedEntityId: EntityId, settingName: typeof name_2): ValueType_2;
}
...
declare interface GetOtherEntitySetting_4 {
     ...
     * @returns {string | null}
     */
    getOtherEntitySetting(relevantPlayerId: PlayerId, targetedEntityId: EntityId, settingName: typeof name_3): ValueType_3;
}
...
declare interface GetOtherEntitySetting_5 {
     ...
     * @returns {boolean}
     */
    getOtherEntitySetting(relevantPlayerId: PlayerId, targetedEntityId: EntityId, settingName: typeof name_4): ValueType_4;
}
...
declare interface GetOtherEntitySetting_6 {
     ...
     * @returns {boolean}
     */
    getOtherEntitySetting(relevantPlayerId: PlayerId, targetedEntityId: EntityId, settingName: typeof name_5): ValueType_5;
}
...
declare interface GetOtherEntitySetting_7 {
     ...
     * @returns {boolean}
     */
    getOtherEntitySetting(relevantPlayerId: PlayerId, targetedEntityId: EntityId, settingName: typeof name_6): ValueType_6;
}
...
declare interface GetOtherEntitySetting_8 {
     ...
     * @returns {StringColor}
     */
    getOtherEntitySetting(relevantPlayerId: PlayerId, targetedEntityId: EntityId, settingName: typeof name_7): ValueType_7;
}
...
declare interface GetOtherEntitySetting_9 {
     ...
     * @returns {boolean}
     */
    getOtherEntitySetting(relevantPlayerId: PlayerId, targetedEntityId: EntityId, settingName: typeof name_8): ValueType_8;
}
...
declare type HealthRegenDictionary = Record<MobType, {
    amount: number;
    interval: number;
    startAfter: number;
} | null>;
...
export declare type HostilityRadius<K extends MobType> = HostilityRadiusDictionary[K];
...
export declare type InitialHealth<K extends MobType> = InitialHealthDictionary[K];
...
export declare type JumpMultiplier<K extends MobType> = JumpMultiplierDictionary[K];
...
export declare type MaxFollowingRadius<K extends MobType> = MaxFollowingRadiusDictionary[K];
...
export declare type MinFollowingRadius<K extends MobType> = MinFollowingRadiusDictionary[K];
...
export declare type OnTamedHealthMultiplier<K extends MobType> = OnTamedHealthMultiplierDictionary[K];
...
export declare type RidingSpeedMult<K extends MobType> = RidingSpeedMultDictionary[K];
 ...
 */
declare type RootGetDefaultMobSetting = <TMobType extends MobType, TMobSetting extends keyof MobSettings<TMobType>>(mobType: TMobType, setting: TMobSetting) => MobSettings<TMobType>[TMobSetting];
 ...
 */
declare type RootGetMobSetting = <TMobSetting extends keyof MobSettings<MobType>>(mobId: MobId, setting: TMobSetting, returnDefaultIfNotOverridden?: boolean) => MobSettings<MobType>[TMobSetting];
 ...
 */
declare type RootGetOtherEntitySetting = <Setting extends keyof EntitySettings>(relevantPlayerId: PlayerId, targetedEntityId: EntityId, settingName: Setting) => EntitySettings[Setting];
 ...
 * @returns {void}
 */
declare type RootSetDefaultMobSetting = <TMobType extends MobType, TMobSetting extends keyof MobSettings<TMobType>>(mobType: TMobType, setting: TMobSetting, value: MobSettings<TMobType>[TMobSetting]) => void;
 ...
 * @returns {void}
 */
declare type RootSetEveryoneSettingForPlayer = <Setting extends keyof EntitySettings>(playerId: PlayerId, settingName: Setting, settingValue: EntitySettings[Setting], includeNewJoiners?: boolean) => void;
 ...
 * @returns {void}
 */
declare type RootSetMobSetting = <TMobSetting extends keyof MobSettings<MobType>>(mobId: MobId, setting: TMobSetting, value: MobSettings<MobType>[TMobSetting]) => void;
 ...
 * @returns {void}
 */
declare type RootSetOtherEntitySetting = <Setting extends keyof EntitySettings>(relevantPlayerId: PlayerId, targetedEntityId: EntityId, settingName: Setting, settingValue: EntitySettings[Setting]) => void;
 ...
 * @returns {void}
 */
declare type RootSetTargetedPlayerSettingForEveryone = <Setting extends keyof EntitySettings>(targetedPlayerId: PlayerId, settingName: Setting, settingValue: EntitySettings[Setting], includeNewJoiners?: boolean) => void;

export declare type Rotation = [Radian, Radian, Radian];

export declare type RunAwayRadius<K extends MobType> = RunAwayRadiusDictionary[K];

declare type RunAwayRadiusDictionary = Record<MobType, number>;

export declare type RunningSpeedMultiplier<K extends MobType> = RunningSpeedMultiplierDictionary[K];

declare type RunningSpeedMultiplierDictionary = Record<MobType, number>;

export declare type SecondaryAttackDamage<K extends MobType> = SecondaryAttackDamageDictionary[K];

declare type SecondaryAttackDamageDictionary = Record<MobType, number>;

export declare type SecondaryAttackImpulse<K extends MobType> = SecondaryAttackImpulseDictionary[K];

declare type SecondaryAttackImpulseDictionary = Record<MobType, number>;

export declare type SecondaryAttackItemName<K extends MobType> = SecondaryAttackItemNameDictionary[K];

declare type SecondaryAttackItemNameDictionary = Record<MobType, Item | null>;

export declare type SecondaryAttackRadius<K extends MobType> = SecondaryAttackRadiusDictionary[K];

declare type SecondaryAttackRadiusDictionary = Record<MobType, number>;

export declare type SecondaryAttackSound<K extends MobType> = SecondaryAttackSoundDictionary[K];

declare type SecondaryAttackSoundDictionary = Record<MobType, SoundName | string | null>;

export declare type SecondaryBurstAttackInfo<K extends MobType> = SecondaryBurstAttackInfoDictionary[K];

declare type SecondaryBurstAttackInfoDictionary = Record<MobType, {
    burstAttackIntervals: readonly number[];
} | null>;
...
declare interface SetClientOption_10 {
     ...
     * @returns {void}
     */
    setClientOption(playerId: PlayerId, option: "musicVolumeLevel", value: number): void;
}
...
declare interface SetClientOption_11 {
     ...
     * @returns {void}
     */
    setClientOption(playerId: PlayerId, option: "showPlayersInUnloadedChunks", value: boolean): void;
}
...
declare interface SetClientOption_13 {
     ...
     * @returns {void}
     */
    setClientOption(playerId: PlayerId, option: "useFullInventory", value: boolean): void;
}
...
declare interface SetClientOption_17 {
     ...
     * @returns {void}
     */
    setClientOption(playerId: PlayerId, option: "zoomOutDistance", value: number): void;
}
...
declare interface SetClientOption_25 {
     ...
     * @returns {void}
     */
    setClientOption(playerId: PlayerId, option: "strictFluidBuckets", value: boolean): void;
}
...
declare interface SetClientOption_26 {
     ...
     * @returns {void}
     */
    setClientOption(playerId: PlayerId, option: "canUseZoomKey", value: boolean): void;
}
...
declare interface SetClientOption_29 {
     ...
     * @returns {void}
     */
    setClientOption(playerId: PlayerId, option: "showBasicMovementControls", value: boolean): void;
}
...
declare interface SetClientOption_31 {
     ...
     * @returns {void}
     */
    setClientOption(playerId: PlayerId, option: "middleTextLower", value: string | CustomTextStyling): void;
}
...
declare interface SetClientOption_32 {
     ...
     * @returns {void}
     */
    setClientOption(playerId: PlayerId, option: "crosshairText", value: string | CustomTextStyling): void;
}
...
declare interface SetClientOption_35 {
     ...
     * @returns {void}
     */
    setClientOption(playerId: PlayerId, option: "showProgressBar", value: boolean): void;
}
...
declare interface SetClientOption_36 {
     ...
     * @returns {void}
     */
    setClientOption(playerId: PlayerId, option: "showKillfeed", value: boolean): void;
}
...
declare interface SetClientOption_37 {
     ...
     * @returns {void}
     */
    setClientOption(playerId: PlayerId, option: "chatChannels", value: {
        channelName: string;
        elementContent: string | CustomTextStyling;
        elementBgColor: string;
    }[]): void;
...
declare interface SetClientOption_41 {
     ...
     * @returns {void}
     */
    setClientOption(playerId: PlayerId, option: "compassTarget", value: string | number | number[]): void;
}
...
declare interface SetClientOption_48 {
     ...
     * @returns {void}
     */
    setClientOption(playerId: PlayerId, option: "initialHealth", value: number): void;
}
...
declare interface SetClientOption_52 {
     ...
     * @returns {void}
     */
    setClientOption(playerId: PlayerId, option: "effectDamageDuration", value: number): void;
}
...
declare interface SetClientOption_53 {
     ...
     * @returns {void}
     */
    setClientOption(playerId: PlayerId, option: "effectSpeedDuration", value: number): void;
}
...
declare interface SetClientOption_54 {
     ...
     * @returns {void}
     */
    setClientOption(playerId: PlayerId, option: "effectDamageReductionDuration", value: number): void;
}
...
declare interface SetClientOption_56 {
     ...
     * @returns {void}
     */
    setClientOption(playerId: PlayerId, option: "potionEffectDuration", value: number): void;
}
...
declare interface SetClientOption_63 {
     ...
     * @returns {void}
     */
    setClientOption(playerId: PlayerId, option: "airMomentumConservation", value: boolean): void;
}
...
declare interface SetClientOption_65 {
     ...
     * @returns {void}
     */
    setClientOption(playerId: PlayerId, option: "autoRespawn", value: boolean): void;
}
...
declare interface SetClientOption_69 {
     ...
     * @returns {void}
     */
    setClientOption(playerId: PlayerId, option: "dealingDamageLegMultiplier", value: number): void;
}
...
declare interface SetClientOption_72 {
     ...
     * @returns {void}
     */
    setClientOption(playerId: PlayerId, option: "fallDamage", value: boolean): void;
}
...
declare interface SetClientOption_77 {
     ...
     * @returns {void}
     */
    setClientOption(playerId: PlayerId, option: "receivingDamageMultiplier", value: number): void;
}
...
declare interface SetClientOption_78 {
     ...
     * @returns {void}
     */
    setClientOption(playerId: PlayerId, option: "respawnButtonText", value: string): void;
}
...
declare interface SetClientOption_8 {
     ...
     * @returns {void}
     */
    setClientOption(playerId: PlayerId, option: "airJumpCount", value: number): void;
}
...
declare interface SetClientOptionToDefault_10 {
     ...
     * @returns {void}
     */
    setClientOptionToDefault(playerId: PlayerId, option: "musicVolumeLevel"): void;
}
...
declare interface SetClientOptionToDefault_11 {
     ...
     * @returns {void}
     */
    setClientOptionToDefault(playerId: PlayerId, option: "showPlayersInUnloadedChunks"): void;
}
...
declare interface SetClientOptionToDefault_13 {
     ...
     * @returns {void}
     */
    setClientOptionToDefault(playerId: PlayerId, option: "useFullInventory"): void;
}
...
declare interface SetClientOptionToDefault_25 {
     ...
     * @returns {void}
     */
    setClientOptionToDefault(playerId: PlayerId, option: "strictFluidBuckets"): void;
}
...
declare interface SetClientOptionToDefault_29 {
     ...
     * @returns {void}
     */
    setClientOptionToDefault(playerId: PlayerId, option: "showBasicMovementControls"): void;
}
...
declare interface SetClientOptionToDefault_52 {
     ...
     * @returns {void}
     */
    setClientOptionToDefault(playerId: PlayerId, option: "effectDamageDuration"): void;
}
...
declare interface SetClientOptionToDefault_53 {
     ...
     * @returns {void}
     */
    setClientOptionToDefault(playerId: PlayerId, option: "effectSpeedDuration"): void;
}
...
declare interface SetClientOptionToDefault_54 {
     ...
     * @returns {void}
     */
    setClientOptionToDefault(playerId: PlayerId, option: "effectDamageReductionDuration"): void;
}
...
declare interface SetClientOptionToDefault_56 {
     ...
     * @returns {void}
     */
    setClientOptionToDefault(playerId: PlayerId, option: "potionEffectDuration"): void;
}
...
declare interface SetClientOptionToDefault_63 {
     ...
     * @returns {void}
     */
    setClientOptionToDefault(playerId: PlayerId, option: "airMomentumConservation"): void;
}
...
declare interface SetClientOptionToDefault_69 {
     ...
     * @returns {void}
     */
    setClientOptionToDefault(playerId: PlayerId, option: "dealingDamageLegMultiplier"): void;
}
...
declare interface SetClientOptionToDefault_77 {
     ...
     * @returns {void}
     */
    setClientOptionToDefault(playerId: PlayerId, option: "receivingDamageMultiplier"): void;
}
...
declare interface SetClientOptionToDefault_78 {
     ...
     * @returns {void}
     */
    setClientOptionToDefault(playerId: PlayerId, option: "respawnButtonText"): void;
}
...
declare interface SetEveryoneSettingForPlayer_10 {
     ...
     * @returns {void}
     */
    setEveryoneSettingForPlayer(playerId: PlayerId, settingName: typeof name_9, settingValue: ValueType_9, includeNewJoiners?: boolean): void;
}
...
declare interface SetEveryoneSettingForPlayer_11 {
     ...
     * @returns {void}
     */
    setEveryoneSettingForPlayer(playerId: PlayerId, settingName: typeof name_10, settingValue: ValueType_10, includeNewJoiners?: boolean): void;
}
...
declare interface SetEveryoneSettingForPlayer_12 {
     ...
     * @returns {void}
     */
    setEveryoneSettingForPlayer(playerId: PlayerId, settingName: typeof name_11, settingValue: ValueType_11, includeNewJoiners?: boolean): void;
}
...
declare interface SetEveryoneSettingForPlayer_13 {
     ...
     * @returns {void}
     */
    setEveryoneSettingForPlayer(playerId: PlayerId, settingName: typeof name_12, settingValue: ValueType_12, includeNewJoiners?: boolean): void;
}
...
declare interface SetEveryoneSettingForPlayer_14 {
     ...
     * @returns {void}
     */
    setEveryoneSettingForPlayer(playerId: PlayerId, settingName: typeof name_13, settingValue: ValueType_13, includeNewJoiners?: boolean): void;
}
...
declare interface SetEveryoneSettingForPlayer_3 {
     ...
     * @returns {void}
     */
    setEveryoneSettingForPlayer(playerId: PlayerId, settingName: typeof name_2, settingValue: ValueType_2, includeNewJoiners?: boolean): void;
}
...
declare interface SetEveryoneSettingForPlayer_4 {
     ...
     * @returns {void}
     */
    setEveryoneSettingForPlayer(playerId: PlayerId, settingName: typeof name_3, settingValue: ValueType_3, includeNewJoiners?: boolean): void;
}
...
declare interface SetEveryoneSettingForPlayer_5 {
     ...
     * @returns {void}
     */
    setEveryoneSettingForPlayer(playerId: PlayerId, settingName: typeof name_4, settingValue: ValueType_4, includeNewJoiners?: boolean): void;
}
...
declare interface SetEveryoneSettingForPlayer_6 {
     ...
     * @returns {void}
     */
    setEveryoneSettingForPlayer(playerId: PlayerId, settingName: typeof name_5, settingValue: ValueType_5, includeNewJoiners?: boolean): void;
}
...
declare interface SetEveryoneSettingForPlayer_7 {
     ...
     * @returns {void}
     */
    setEveryoneSettingForPlayer(playerId: PlayerId, settingName: typeof name_6, settingValue: ValueType_6, includeNewJoiners?: boolean): void;
}
...
declare interface SetEveryoneSettingForPlayer_8 {
     ...
     * @returns {void}
     */
    setEveryoneSettingForPlayer(playerId: PlayerId, settingName: typeof name_7, settingValue: ValueType_7, includeNewJoiners?: boolean): void;
}
...
declare interface SetEveryoneSettingForPlayer_9 {
     ...
     * @returns {void}
     */
    setEveryoneSettingForPlayer(playerId: PlayerId, settingName: typeof name_8, settingValue: ValueType_8, includeNewJoiners?: boolean): void;
}
...
declare interface SetOtherEntitySetting_10 {
     ...
     * @returns {void}
     */
    setOtherEntitySetting(relevantPlayerId: PlayerId, targetedEntityId: EntityId, settingName: typeof name_9, settingValue: ValueType_9): void;
}
...
declare interface SetOtherEntitySetting_11 {
     ...
     * @returns {void}
     */
    setOtherEntitySetting(relevantPlayerId: PlayerId, targetedEntityId: EntityId, settingName: typeof name_10, settingValue: ValueType_10): void;
}
...
declare interface SetOtherEntitySetting_12 {
     ...
     * @returns {void}
     */
    setOtherEntitySetting(relevantPlayerId: PlayerId, targetedEntityId: EntityId, settingName: typeof name_11, settingValue: ValueType_11): void;
}
...
declare interface SetOtherEntitySetting_13 {
     ...
     * @returns {void}
     */
    setOtherEntitySetting(relevantPlayerId: PlayerId, targetedEntityId: EntityId, settingName: typeof name_12, settingValue: ValueType_12): void;
}
...
declare interface SetOtherEntitySetting_14 {
     ...
     * @returns {void}
     */
    setOtherEntitySetting(relevantPlayerId: PlayerId, targetedEntityId: EntityId, settingName: typeof name_13, settingValue: ValueType_13): void;
}
...
declare interface SetOtherEntitySetting_3 {
     ...
     * @returns {void}
     */
    setOtherEntitySetting(relevantPlayerId: PlayerId, targetedEntityId: EntityId, settingName: typeof name_2, settingValue: ValueType_2): void;
}
...
declare interface SetOtherEntitySetting_4 {
     ...
     * @returns {void}
     */
    setOtherEntitySetting(relevantPlayerId: PlayerId, targetedEntityId: EntityId, settingName: typeof name_3, settingValue: ValueType_3): void;
}
...
declare interface SetOtherEntitySetting_5 {
     ...
     * @returns {void}
     */
    setOtherEntitySetting(relevantPlayerId: PlayerId, targetedEntityId: EntityId, settingName: typeof name_4, settingValue: ValueType_4): void;
}
...
declare interface SetOtherEntitySetting_6 {
     ...
     * @returns {void}
     */
    setOtherEntitySetting(relevantPlayerId: PlayerId, targetedEntityId: EntityId, settingName: typeof name_5, settingValue: ValueType_5): void;
}
...
declare interface SetOtherEntitySetting_7 {
     ...
     * @returns {void}
     */
    setOtherEntitySetting(relevantPlayerId: PlayerId, targetedEntityId: EntityId, settingName: typeof name_6, settingValue: ValueType_6): void;
}
...
declare interface SetOtherEntitySetting_8 {
     ...
     * @returns {void}
     */
    setOtherEntitySetting(relevantPlayerId: PlayerId, targetedEntityId: EntityId, settingName: typeof name_7, settingValue: ValueType_7): void;
}
...
declare interface SetOtherEntitySetting_9 {
     ...
     * @returns {void}
     */
    setOtherEntitySetting(relevantPlayerId: PlayerId, targetedEntityId: EntityId, settingName: typeof name_8, settingValue: ValueType_8): void;
}
...
declare interface SetTargetedPlayerSettingForEveryone_10 {
     ...
     * @param {boolean} [includeNewJoiners]
     */
    setTargetedPlayerSettingForEveryone(targetedPlayerId: PlayerId, settingName: typeof name_9, settingValue: ValueType_9, includeNewJoiners?: boolean): void;
}
...
declare interface SetTargetedPlayerSettingForEveryone_11 {
     ...
     * @param {boolean} includeNewJoiners
     */
    setTargetedPlayerSettingForEveryone(targetedPlayerId: PlayerId, settingName: typeof name_10, settingValue: ValueType_10, includeNewJoiners?: boolean): void;
}
...
declare interface SetTargetedPlayerSettingForEveryone_12 {
     ...
     * @param {boolean} includeNewJoiners
     */
    setTargetedPlayerSettingForEveryone(targetedPlayerId: PlayerId, settingName: typeof name_11, settingValue: ValueType_11, includeNewJoiners?: boolean): void;
}
...
declare interface SetTargetedPlayerSettingForEveryone_13 {
     ...
     * @param {boolean} includeNewJoiners
     */
    setTargetedPlayerSettingForEveryone(targetedPlayerId: PlayerId, settingName: typeof name_12, settingValue: ValueType_12, includeNewJoiners?: boolean): void;
}
...
declare interface SetTargetedPlayerSettingForEveryone_14 {
     ...
     * @param {boolean} [includeNewJoiners]
     */
    setTargetedPlayerSettingForEveryone(targetedPlayerId: PlayerId, settingName: typeof name_13, settingValue: ValueType_13, includeNewJoiners?: boolean): void;
}
...
declare interface SetTargetedPlayerSettingForEveryone_3 {
     ...
     * @param {boolean} includeNewJoiners
     */
    setTargetedPlayerSettingForEveryone(targetedPlayerId: PlayerId, settingName: typeof name_2, settingValue: ValueType_2, includeNewJoiners?: boolean): void;
}
...
declare interface SetTargetedPlayerSettingForEveryone_4 {
     ...
     * @param {boolean} includeNewJoiners
     */
    setTargetedPlayerSettingForEveryone(targetedPlayerId: PlayerId, settingName: typeof name_3, settingValue: ValueType_3, includeNewJoiners?: boolean): void;
}
...
declare interface SetTargetedPlayerSettingForEveryone_5 {
     ...
     * @param {boolean} [includeNewJoiners]
     */
    setTargetedPlayerSettingForEveryone(targetedPlayerId: PlayerId, settingName: typeof name_4, settingValue: ValueType_4, includeNewJoiners?: boolean): void;
}
...
declare interface SetTargetedPlayerSettingForEveryone_6 {
     ...
     * @param {boolean} [includeNewJoiners]
     */
    setTargetedPlayerSettingForEveryone(targetedPlayerId: PlayerId, settingName: typeof name_5, settingValue: ValueType_5, includeNewJoiners?: boolean): void;
}
...
declare interface SetTargetedPlayerSettingForEveryone_7 {
     ...
     * @param {boolean} [includeNewJoiners]
     */
    setTargetedPlayerSettingForEveryone(targetedPlayerId: PlayerId, settingName: typeof name_6, settingValue: ValueType_6, includeNewJoiners?: boolean): void;
}
...
declare interface SetTargetedPlayerSettingForEveryone_8 {
     ...
     * @param {boolean} [includeNewJoiners]
     */
    setTargetedPlayerSettingForEveryone(targetedPlayerId: PlayerId, settingName: typeof name_7, settingValue: ValueType_7, includeNewJoiners?: boolean): void;
}
...
declare interface SetTargetedPlayerSettingForEveryone_9 {
     ...
     * @param {boolean} [includeNewJoiners]
     */
    setTargetedPlayerSettingForEveryone(targetedPlayerId: PlayerId, settingName: typeof name_8, settingValue: ValueType_8, includeNewJoiners?: boolean): void;
}
...
export declare type StoppingRadius<K extends MobType> = StoppingRadiusDictionary[K];
...
export declare type SwingArmOnAttack<K extends MobType> = SwingArmOnAttackDictionary[K];

declare type SwingArmOnAttackDictionary = Record<MobType, boolean>;

export declare type SwingArmOnSecondaryAttack<K extends MobType> = SwingArmOnSecondaryAttackDictionary[K];
...
export declare type TerritoryRadius<K extends MobType> = TerritoryRadiusDictionary[K];
 ...
 */
declare type ValueType_9 = "default" | "yellow" | "lime" | "green" | "aqua" | "cyan" | "blue" | "purple" | "pink" | "red" | "orange";
...
export declare type WalkingSpeedMultiplier<K extends MobType> = WalkingSpeedMultiplierDictionary[K];

declare type WalkingSpeedMultiplierDictionary = Record<MobType, number>;

export declare type WalkThroughType = 0 | 1 | 2;

export declare type WhoDidDamage = LifeformId | {
